%The workspace delineates an experiment aiming to show how randomly
%generated partitions behave in the ensemble clustering framework
%
%DDA 09.05.2017
%
...
for j = 1 : numDs 
    ...
    %generate a random ensemble of M partitions for the dataset dsName and
    %ensures that the variation of information of the partitions in the
    %ensemble is as close to 2log2K as possible. This means we have the
    %maximum variability possible
    E = highVIrandomEnsemble(N, K, M, 0.2);
    disp('random ensemble generated');
