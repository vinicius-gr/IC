...
for j = 1 : numDs 
    ...
    %generate a random ensemble of M partitions for the dataset dsName
    E = randomEnsemble( N, K, M );
    
    %ensure that the variation of information of the partitions in the
